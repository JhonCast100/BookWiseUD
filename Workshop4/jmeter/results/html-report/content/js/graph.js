...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 10.0, "minX": 0.0, "maxY": 10.0, "series": [{"data": [[0.0, 10.0]], "isOverall": false, "label": "POST /api/auth/login", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 4.9E-324, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.76399964E12, "maxY": 1.0, "series": [{"data": [[1.76399964E12, 1.0]], "isOverall": false, "label": "Login Load", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76399964E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 3.8999999999999995, "minX": 1.0, "maxY": 3.8999999999999995, "series": [{"data": [[1.0, 3.8999999999999995]], "isOverall": false, "label": "POST /api/auth/login", "isController": false}, {"data": [[1.0, 3.8999999999999995]], "isOverall": false, "label": "POST /api/auth/login-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 1.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 3.8999999999999995, "minX": 1.76399964E12, "maxY": 3.8999999999999995, "series": [{"data": [[1.76399964E12, 3.8999999999999995]], "isOverall": false, "label": "POST /api/auth/login", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76399964E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.76399964E12, "maxY": 4.9E-324, "series": [{"data": [[1.76399964E12, 0.0]], "isOverall": false, "label": "POST /api/auth/login", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76399964E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 3.6999999999999993, "minX": 1.76399964E12, "maxY": 3.6999999999999993, "series": [{"data": [[1.76399964E12, 3.6999999999999993]], "isOverall": false, "label": "POST /api/auth/login", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76399964E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 1.0, "minX": 1.0, "maxY": 2.0, "series": [{"data": [[2.0, 1.0], [1.0, 2.0], [3.0, 2.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 3.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 0.16666666666666666, "minX": 1.76399964E12, "maxY": 0.16666666666666666, "series": [{"data": [[1.76399964E12, 0.16666666666666666]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76399964E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 0.16666666666666666, "minX": 1.76399964E12, "maxY": 0.16666666666666666, "series": [{"data": [[1.76399964E12, 0.16666666666666666]], "isOverall": false, "label": "POST /api/auth/login-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76399964E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
